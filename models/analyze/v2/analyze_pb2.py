...
# source: analyze/v2/analyze.proto
...
Class_ = _reflection.GeneratedProtocolMessageType('Class_', (_message.Message,), {
  'DESCRIPTOR' : _CLASS_,
  '__module__' : 'analyze.v2.analyze_pb2'
